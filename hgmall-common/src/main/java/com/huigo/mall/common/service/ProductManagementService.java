package com.huigo.mall.common.service;
...
public class ProductManagementService {
    ...
    public ShopProductVO createProduct(Long shopId, String name, String description, String imageUrl,
                                      Long categoryId, List<com.huigo.mall.common.domain.CreateSkuRequest> skus,
        ...
        // 创建SKU列表
        for (com.huigo.mall.common.domain.CreateSkuRequest skuRequest : skus) {
            Sku sku = new Sku();
     ...
     */
    @Transactional
    public List<SkuVO> addSku(Long productId, List<com.huigo.mall.common.domain.CreateSkuRequest> skus,
                              Long merchantId, Long operatorUserId) {
        // 验证权限和商品
        validateProductOwnership(productId, merchantId);
