package com.huigo.mall.admin.service;

import com.huigo.mall.common.constant.OrderStatus;
import com.huigo.mall.common.domain.MerchantOrderListVO;
import com.huigo.mall.common.domain.MerchantOrderVO;
import com.huigo.mall.common.domain.OrderStatisticsVO;
import com.huigo.mall.mapper.*;
import com.huigo.mall.model.*;
...
public class AdminOrderService {
    ...
    public MerchantOrderVO getOrderDetail(Long orderId) {
        ...
        // 查询订单项
        List<com.huigo.mall.common.domain.MerchantOrderItemVO> orderItems = getOrderItems(orderId);
        ...
        if (order.getAddressId() != null) {
            ...
            if (address != null) {
                com.huigo.mall.common.domain.AddressVO addressVO = new com.huigo.mall.common.domain.AddressVO();
    ...
    private List<MerchantOrderVO> convertToMerchantOrderVOList(List<Map<String, Object>> orderMaps) {
        ...
        for (Map<String, Object> map : orderMaps) {
            ...
            // 查询订单项
            List<com.huigo.mall.common.domain.MerchantOrderItemVO> orderItems = getOrderItems(vo.getOrderId());
            vo.setOrderItems(orderItems);
     ...
     * 获取订单项列表
     */
    private List<com.huigo.mall.common.domain.MerchantOrderItemVO> getOrderItems(Long orderId) {
        OrderItemExample example = new OrderItemExample();
        example.createCriteria().andOrderIdEqualTo(orderId);
        List<OrderItem> items = orderItemMapper.selectByExample(example);

        List<com.huigo.mall.common.domain.MerchantOrderItemVO> itemVOs = new ArrayList<>();
        for (OrderItem item : items) {
            com.huigo.mall.common.domain.MerchantOrderItemVO itemVO = new com.huigo.mall.common.domain.MerchantOrderItemVO();
